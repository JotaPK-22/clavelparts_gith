...
const MAIN_CATEGORIES = [
  ...
  { label: 'Distribución', aliases: ['Distribución', 'Correas y distribución'] },
  { label: 'Lubricación', aliases: ['Lubricación', 'Filtros', 'Aceites'] },
  { label: 'Encendido', aliases: ['Encendido', 'Bujías y bobinas'] },
  { label: 'Suspensión', aliases: ['Suspensión', 'Suspensión y Dirección', 'Amortiguadores'] },
  ...
  { label: 'Electricidad', aliases: ['Electricidad', 'Eléctrico', 'Sensores', 'Iluminación'] },
  ...
  { label: 'Ruedas y Neumáticos', aliases: ['Ruedas y Neumáticos', 'Ruedas', 'Neumáticos', 'Llantas'] },
  { label: 'Carrocería', aliases: ['Carrocería', 'Ópticas'] },
  { label: 'Accesorios', aliases: ['Accesorios', 'Detailing'] },
